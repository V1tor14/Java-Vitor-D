...
const perguntas = [
    {
        enunciado:"o futebol é o esporte mais emocionante do mundo?",
        alternativas: [
            {
                texto: "Não,porque existe outros esportes mais emocionates",
                afirmacao: "outros jogos de esporte podem dar mais emoção quando seu time está ganhando",
            },

            {

                texto: "Sim,porque quando seu time ganha voce fica emocionado",
                afirmação: "o futebol fica mais divertido quando voce ve seu time sendo campeão",
